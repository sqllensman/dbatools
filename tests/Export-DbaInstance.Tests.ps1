...
Describe "$CommandName Unit Tests" -Tag 'UnitTests' {
    Context "Validate parameters" {
        ...
        [object[]]$knownParameters = 'SqlInstance', 'SqlCredential', 'Credential', 'Path', 'NoRecovery', 'Include', 'Exclude', 'BatchSeparator', 'Append', 'ScriptingOption', 'NoPrefix', 'ExcludePassword', 'OutputStyle', 'EnableException'
